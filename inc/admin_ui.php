...
//fast way of removing empty arrays
//http://hasin.wordpress.com/2009/09/16/removing-empty-elements-from-an-array-the-php-way/
$empty_elements = array("");
$path = array_diff($path,$empty_elements);
...
<table class="form-table">
    ...
    <tr valign="top">
      ...
      <tr valign="top">
          ...
          <td><input type="text" name="s4w_solr_path[]" value="<?php print $path[$x]; ?>" /></td>
      </tr>
      <?php } ?>
</table>
<hr />
